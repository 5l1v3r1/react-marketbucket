        ...
        <Modal isOpen={modal} toggle={toggleModal} >
          ...
          <ModalBody>
            <ul style={{ listStyleType: 'none' }}>
              {lazada ? null : <>
                <li>
                  <a href="https://marketbucketserver.herokuapp.com/api/v1/marketplaces/check/lazada">
              ...
              {shopee ? null : <>
                <li>
                  <a href="https://marketbucketserver.herokuapp.com/api/v1/marketplaces/check/shopee">
