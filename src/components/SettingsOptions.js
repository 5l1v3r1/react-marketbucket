...
export default class SettingsOptions extends Component {
  ...
  componentDidMount() {
    axios({
      method: 'get',
      url: 'https://marketbucketserver.herokuapp.com/api/v1/users/me',
      headers: {
  ...
  handleSubmit = (e) => {
    ...
    if (password === passwordConfirm) {
      axios({
        method: 'put',
        url: 'https://marketbucketserver.herokuapp.com/api/v1/users/update',
        headers: {
          'content-type': 'application/json',
          'authorization': `Bearer ${localStorage.jwt}`
        },
  ...
  handleDelete = ({ target }) => {
    ...
    axios({
      method: 'delete',
      url: 'https://marketbucketserver.herokuapp.com/api/v1/marketplaces/delete',
      headers: {
        'content-type': 'application/json',
        'authorization': `Bearer ${localStorage.jwt}`
      },
